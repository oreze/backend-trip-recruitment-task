...
public class Trip
{
    ...
    public string CountryThreeLetterCode { get; private set; }
    ...
    private static void ValidateInput(string name, string? description, DateTime startDate, int numberOfSeats, Country country)
    {
        ...
        if (numberOfSeats is >= 1 and <= 100)
            throw new InputException(nameof(numberOfSeats), "Trip number of seats must be between 1 and 100 inclusive.");
